            ...
            <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="flex gap-1 items-center">
                  ...
                  <span class="text-darkGrey text-sm tracking-035 leading-[22px]">{{date('d M Y', strtotime($packageBooking->start_date))}} - {{date('d M Y', strtotime($packageBooking->end_date))}}</span>
                </div>
