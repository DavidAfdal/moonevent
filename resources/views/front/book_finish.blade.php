    ...
    <section id="content" class="max-w-[640px] w-full mx-auto bg-blue min-h-screen">
        <div class="w-full min-h-screen flex flex-col items-center justify-center py-[46px] px-[28px] gap-8">
          ...
          <div class="flex flex-col gap-2 items-center text-center w-[319px] mx-auto">
            ...
            <p class="text-white">Terima Kasih Telah Memilih Kami<br>Kami merasa terhormat telah menjadi bagian dari hari istimewa Anda. Dengan penuh cinta dan dedikasi, kami akan memastikan setiap detail pernikahan Anda menjadi kenangan yang tak terlupakan.</p>
          </div>
