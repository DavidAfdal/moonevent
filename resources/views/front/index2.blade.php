...
@section('content')
  <section>
    <nav class="flex w-full items-center justify-between px-[65px] py-4 bg-[#F5F5F5]">
    ...
    <div class="w-[24%] border border-[#DFCDCB] rounded-full py-0 px-2">
      <img src="{{ asset('assets/photos/cardTeam.jpg') }}" class="w-full h-[300px] rounded-tl-full rounded-tr-full object-cover" alt="">
