  ...
  <section>
    ...
    <div class="px-[20px] md:px-[65px] mt-24">
      <div class="relative w-full">
        ...
        <div
          ...
          <h2
            class="text-white max-w-[450px] md:max-w-[650px] lg:max-w-[850px] text-2xl md:text-3xl lg:text-7xl mb-5 font-semibold mt-5">
            Wedding Services
          </h2>
          <p class="md:max-w-[550px] lg:max-w-[760px] text-base text-white">
    ...
    <div class="px-[20px] md:px-[65px] mt-24">
      <div class="grid grid-cols-2 gap-4">
        <div class="">
          ...
          <h1 class="text-5xl/snug font-semibold mt-8">
            Join a Growing Community of Business and Logistics Partners
          </h1>
          <p class="text-black opacity-70 max-w-[550px] mt-5">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div
            class="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col justify-center items-center text-center rounded-2xl px-4 cursor-pointer">
            <h2 class="text-6xl text-[#FF7043] font-semibold">25</h2>
            <p class="text-xl text-black opacity-70 mt-3">Years of Industry Experience</p>
          </div>
          <div
            class="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col justify-center items-center text-center rounded-2xl px-4 cursor-pointer">
            <h2 class="text-6xl text-[#FF7043] font-semibold">300+</h2>
            <p class="text-xl text-black opacity-70 mt-3">
              Employees for Your Success
            </p>
          </div>
          <div
            class="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col justify-center items-center text-center rounded-2xl px-4 cursor-pointer">
            <h2 class="text-6xl text-[#FF7043] font-semibold">500+</h2>
            <p class="text-xl text-black opacity-70 mt-3">
          ...
          <div
            class="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col justify-center items-center text-center rounded-2xl px-4 cursor-pointer">
            <h2 class="text-6xl text-[#FF7043] font-semibold">99%</h2>
            <p class="text-xl text-black opacity-70 mt-3">
              On-Time Delivery
            </p>
          </div>
    ...
    <div class="px-[20px] md:px-[65px] mt-24">
      <div class="text-center flex flex-col justify-center flex-items max-w-[950px] mx-auto ">
        ...
        <p class="text-black opacity-70 mt-5">
      ...
      <div class="grid grid-cols-3 gap-5 mt-20">
        @foreach ($servicesWedding as $wedding)
          <div
            ...
            <div class="">
              <i
                class="{{ $wedding['icon'] }}fa-regular fa-bell w-fit h-auto px-5 py-3 text-3xl bg-[#FF7043]/40 text-[#FF7043] group-hover:bg-white transition-all duration-300 rounded-xl"></i>
              <h3 class="text-xl font-semibold my-4">
                {{ $wedding['title'] }}
              </h3>
              <p class="text-black/70 text-base group-hover:text-white transition-all duration-300">
                {{ $wedding['desc'] }}
              </p>
            </div>
          </div>
    ...
    <div class="px-[20px] md:px-[65px] my-32">
      <div class="">
        ...
        <h1 class="text-5xl font-semibold mt-5">
      ...
      <div class="mt-10 grid grid-cols-2 gap-8">
        <div class="">
          ...
          <img
            ...
            class="w-[550px] h-[270px] object-cover" alt="">
        </div>
        <div class="flex flex-col gap-20">
          <div class="border-y border-[#FF7043] flex items-start py-8 gap-8">
            <h1 class="text-8xl text-[#FF7043]/70">01</h1>
            <div class="">
              <h2 class="text-2xl mb-3 font-semibold">In-Depth Consultation</h2>
          ...
          <div class="flex items-start gap-8">
            <h1 class="text-8xl text-[#FF7043]/70">02</h1>
            <div class="">
              <h2 class="text-2xl mb-3 font-semibold">In-Depth Consultation</h2>
              <p class="text-black/70">
                Carefully assessing your logistics needs to
          ...
          <div class="flex items-start gap-8">
            <h1 class="text-8xl text-[#FF7043]/70">03</h1>
            <div class="">
              <h2 class="text-2xl mb-3 font-semibold">In-Depth Consultation</h2>
              <p class="text-black/70">
                Carefully assessing your logistics needs to
          ...
          <div class="flex items-start gap-8">
            <h1 class="text-8xl text-[#FF7043]/70">04</h1>
            <div class="">
              <h2 class="text-2xl mb-3 font-semibold">In-Depth Consultation</h2>
              <p class="text-black/70">
                Carefully assessing your logistics needs to
