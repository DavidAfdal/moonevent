  ...
  <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
    ...
    <div id="recommendations" class="flex flex-col gap-3">
      ...
      <div class="main-carousel card-container">
        {{-- live chat --}}
        <script
          type="text/javascript">window.$crisp = []; window.CRISP_WEBSITE_ID = "56d76d2e-7505-4643-a7d4-9e65ef83d7a5"; (function () { d = document; s = d.createElement("script"); s.src = "https://client.crisp.chat/l.js"; s.async = 1; d.getElementsByTagName("head")[0].appendChild(s); })();</script>
    ...
    <div id="recommendations" class="flex flex-col gap-3">
      ...
      <div class="main-carousel card-container">
        ...
        <a href="#" class="group px-2 first-of-type:pl-4 last-of-type:pr-4">
          <div class="w-[288px] p-4 flex flex-col gap-3 rounded-[26px] bg-white shadow-[6px_8px_20px_0_#00000008]">
            <div class="w-full h-[330px] rounded-xl flex shrink-0 overflow-hidden">
              <img src="{{asset('assets/vendor/PESONAALAMANDA.jpg')}}" class="w-full h-full object-cover"
                alt="thumbnails">
            </div>
          </div>
        </a>
    ...
    <div class="container mx-auto text-center">
      ...
      <h2 class="text-lg">
        Moonevent Organizer adalah perusahaan penyedia layanan jasa Wedding Organizer dan pengelola gedung JGU Auditorium
        yang terletak di Depok, Jawa Barat. Berdiri pada tanggal 26 Oktober 2020, kami berdedikasi untuk memberikan
        layanan terbaik dalam perencanaan acara dan penyewaan gedung.
      </h2>
    </div>
