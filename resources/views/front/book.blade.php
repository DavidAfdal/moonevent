...
@section('content')
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <form action="{{route('front.book.store', $package_tours->slug)}}" method="POST" class="flex flex-col gap-8">
            @csrf
          ...
          <div class="flex flex-col gap-3 px-4 ">
            ...
            <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
              ...
              <div class="flex flex-col gap-1">
                <p class="font-semibold text-sm tracking-035 leading-[22px] truncate line-clamp-1 ">
                    {{substr($package_tours->name, 0, 20)}} 
                </p>
              ...
              <div class="flex flex-1 items-center justify-end gap-2">
                ...
                <input type="hidden" name="packageTourPrice" id="packageTourPrice" value="{{$package_tours->price}}" />
